    ...
    <div className="d-flex flex-column align-items-center justify-content-start mt-2 w-50">
      <div className="align-items-start">
        <DivCoordonnees
          ...
          logo={emailLogo}
          text={"Emanedanielakim@gmail.com"}
        />
        <DivCoordonnees
          href={"tel:+33623380659"}
          logo={mobileLogo}
          text={"+33623380659"}
        />
        <DivCoordonnees
          href={
            "https://www.instagram.com/akim_emane?igsh=d2NueXY3emV3ZTFv&utm_source=qr"
          }
          logo={instagramLogo}
          text={"Instagram"}
        />
        <DivCoordonnees
          href={"https://www.facebook.com/akimjerking.emane"}
          logo={facebookLogo}
          text={"Facebook"}
        />
      </div>
      ...
      <form className="d-flex flex-column mt-2">
        ...
        <div className="d-inline-flex">
          <select className="form-select w-25" name="indicatif" id="indicatif">
            <option className="" value="+33">
              +33
            </option>
          </select>
          <input
            name="tel"
            className="ms-2 form-control w-75"
            type="tel"
            inputMode="number"
          />
        </div>
        <input
          className="w-25 btn btn-outline-success mt-2"
          type="submit"
          value="Envoyer"
        />
      </form>
...
const TextInfo = () => {
  return (
    <div className="container m-3 w-50 text-center">
      ...
      <h5 className="fw-bold mt-2 mb-2 fst-italic text-nowrap col">
        Contactez-moi pour des réponses
      </h5>
      <div className="w-100 d-flex justify-content-center">
        <Separator width={"80%"} color={"black"} />
      </div>
      <p className="row fst-italic m-auto">
        Si vous avez des questions spécifiques ou si vous souhaitez obtenir des
        informations supplémentaires pour mieux comprendre comment je peux vous
        aider, je vous encourage vivement à me laisser votre numéro de téléphone
        ou votre adresse e-mail. De mon côté, je m'engage à vous contacter dans
        les plus brefs délais afin de répondre à toutes vos interrogations et de
        vous fournir le soutien dont vous avez besoin pour avancer. Votre
        satisfaction et votre réussite sont mes priorités absolues. En tant que
        partenaire dans votre projet, je suis là pour vous accompagner à chaque
        étape de votre parcours. Merci de me faire confiance pour réaliser vos
        objectifs.
      </p>
    </div>
  );
